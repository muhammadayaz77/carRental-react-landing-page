    ...
    <div className='my-20' id='faq'>
      ...
      <div className='lg:w-[60%] md:w-[80%] w-[90%] mx-auto shadow-md'>
        <div className='w-full border-2 overflow-hidden' name="" id="">
         ...
         className={`text-2xl font-semibold px-16 py-5 ${toggle ? 'shadow-lg shadow-[#FF4C30] bg-[#FF4C30] text-white' : 'bg-white'}`}>1. What is special about comparing rental car deals?</h2>
        ...
        <div className='w-full border-2 overflow-hidden' name="" id="">
         ...
         className={`text-2xl font-semibold px-16 py-5 ${toggle2 ? 'shadow-lg shadow-[#FF4C30] bg-[#FF4C30] text-white' : 'bg-white'}`}>2. How do I find the car rental deals?</h2>
        ...
        <div className='w-full border-2 overflow-hidden' name="" id="">
         ...
         className={`text-2xl font-semibold px-16 py-5 ${toggle3 ? 'shadow-lg shadow-[#FF4C30] bg-[#FF4C30] text-white' : 'bg-white'}`}>3. How do I find such low rental car prices?</h2>
