...
function ChooseUs() {
  return (
    <>
    <div className='w-[100%] my-24' id='chooseUs'>
      <div>
      ...
      <div className='grid lg:grid-cols-12 sm:w-[85%] w-[95%] mx-auto'>
        ...
        <div className='lg:col-span-6 col-span-12 pl-7 space-y-6 mt-12 lg:mt-0'>
            <div className='flex items-center space-x-3 sm:mx-12 mx-0 md:mx-28 lg:mx-0'>
              <img src="./public/Images/icon1 (1).png" alt="" />
              <div className=''>
                <h2 className='font-extrabold text-3xl'>Cross Country Drive</h2>
            ...
            <div className='flex items-center space-x-3 sm:mx-12 mx-0 md:mx-28 lg:mx-0'>
              ...
              <div className=''>
                <h2 className='font-extrabold text-3xl'>All Inclusive Pricing</h2>
                <p className='text-[15px] font-light text-gray-500'>Take your driving experience to the next level with our top-notch vehicles for your cross-country adventures.</p>
              </div>
            </div>
            <div className='flex items-center space-x-3 sm:mx-12 mx-0 md:mx-28 lg:mx-0'>
              ...
              <div className=''>
                <h2 className='font-extrabold text-3xl'>No Hidden Charges</h2>
                <p className='text-[15px] font-light text-gray-500'>Take your driving experience to the next level with our top-notch vehicles for your cross-country adventures.</p>
              </div>
            </div>
        </div>
